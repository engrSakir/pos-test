...
<head>
  ...
  <link rel="icon" href="assets/frontend/images/favicon/favicon.png" type="image/x-icon">
  <link rel="shortcut icon" href="assets/frontend/images/favicon/favicon.png" type="image/x-icon">
  ...
  <link rel="stylesheet" type="text/css" href="assets/frontend/css/themify.css">
  ...
  <!-- Theme css -->
  <link rel="stylesheet" type="text/css" href="assets/frontend/css/color2.css" media="screen" id="color">
</head>
<body class="bg-light">
            ...
            <div class="language-block">
              <div class="language-dropdown">
                ...
                <ul class="language-dropdown-open">
                  ...
                  <li><a href="javascript:void(0)">marathi</a></li>
              ...
              <div class="nav-left" >
                ...
                <div class="collapse  nav-desk" id="navbarToggleExternalContent">
                  <ul class="nav-cat title-font">
                    <li> <a href="category-page(left-sidebar).html"><img src="assets/frontend/images/layout-1/nav-img/01.png" alt="category-product"> western ware</a></li>
                    <li> <a href="category-page(left-sidebar).html"><img src="assets/frontend/images/layout-1/nav-img/02.png" alt="category-product"> TV, Appliances</a></li>
                    <li> <a href="category-page(left-sidebar).html"><img src="assets/frontend/images/layout-1/nav-img/03.png" alt="category-product"> Pets Products</a></li>
                    <li> <a href="category-page(left-sidebar).html"><img src="assets/frontend/images/layout-1/nav-img/04.png" alt="category-product"> Car, Motorbike</a></li>
                    <li> <a href="category-page(left-sidebar).html"><img src="assets/frontend/images/layout-1/nav-img/05.png" alt="category-product"> Industrial Products</a></li>
                    <li> <a href="category-page(left-sidebar).html"><img src="assets/frontend/images/layout-1/nav-img/06.png" alt="category-product"> Beauty, Health Products</a></li>
                    <li> <a href="category-page(left-sidebar).html"><img src="assets/frontend/images/layout-1/nav-img/07.png" alt="category-product"> Grocery Products </a></li>
                    <li> <a href="category-page(left-sidebar).html"><img src="assets/frontend/images/layout-1/nav-img/08.png" alt="category-product"> Sports</a></li>
                    <li> <a href="category-page(left-sidebar).html"><img src="assets/frontend/images/layout-1/nav-img/09.png" alt="category-product"> Bags, Luggage</a></li>
                    <li> <a href="category-page(left-sidebar).html"><img src="assets/frontend/images/layout-1/nav-img/10.png" alt="category-product"> Movies, Music </a></li>
                    <li> <a href="category-page(left-sidebar).html"><img src="assets/frontend/images/layout-1/nav-img/11.png" alt="category-product"> Video Games</a></li>
                    <li> <a href="category-page(left-sidebar).html"><img src="assets/frontend/images/layout-1/nav-img/12.png" alt="category-product"> Toys, Baby Products</a></li>
                    <li>
              ...
              <nav id="main-nav">
                ...
                <ul id="main-menu" class="sm pixelstrap sm-horizontal">
                  ...
                  <li>
                    ...
                    <ul>
                      <li><a  href="{{ url('/') }}">mega store 1</a></li>
                      ...
                      <li>
                        <div class="container">
                          ...
                          <div class="row menu-banner">
                            <div class="col-lg-6">
                              <div>
                                <img src="assets/frontend/images/menu-banner1.jpg" alt="menu-banner" class="img-fluid">
                              </div>
                            </div>
                            <div class="col-lg-6">
                              <div>
                                <img src="assets/frontend/images/menu-banner2.jpg" alt="menu-banner" class="img-fluid">
                              </div>
                            </div>
                          </div>
                        </div>
                        ...
                        <div class="container">
                          <div class="row">
                            ...
                            <div class="col mega-box product ">
                              <div class="mega-img">
                                <img src="assets/frontend/images/mega-banner.jpg" alt="menu-banner" class="img-fluid">
                              </div>
                            </div>
                          </div>
                        </div>
            ...
            <div class="category-right">
              ...
              <div class="btn-group">
                ...
                <div class="dropdown-menu gift-dropdown">
                  <div class="media">
                    <div  class="me-3">
                      <img src="assets/frontend/images/icon/1.png" alt="Generic placeholder image">
                    </div>
                    <div class="media-body">
                      <h5 class="mt-0">Billion Days</h5>
                      <p><img src="assets/frontend/images/icon/currency.png" class="cash" alt="curancy"> Flat Rs. 270 Rewards</p>
                    </div>
                  </div>
                  <div class="media">
                    <div  class="me-3">
                      <img src="assets/frontend/images/icon/2.png" alt="Generic placeholder image" class="gift-bloc">
                    </div>
                    <div class="media-body">
                      <h5 class="mt-0">Fashion Discount</h5>
                      <p><img src="assets/frontend/images/icon/fire.png"  class="fire" alt="fire">Extra 10% off (upto Rs. 10,000*) </p>
                    </div>
                  </div>
                  <div class="media">
                    <div  class="me-3">
                      <img src="assets/frontend/images/icon/3.png" alt="Generic placeholder image">
                    </div>
                    <div class="media-body">
                  ...
                  <div class="media">
                    <div  class="me-3">
                      <img src="assets/frontend/images/icon/6.png" alt="Generic placeholder image">
                    </div>
                    <div class="media-body">
                  ...
                  <div class="media">
                    <div  class="me-3">
                      <img src="assets/frontend/images/icon/5.png" alt="Generic placeholder image">
                    </div>
                    <div class="media-body">
                  ...
                  <div class="product-box">
                    <div class="product-imgbox">
                      <div class="product-front">
                        <a href="product-page(left-sidebar).html">
                          <img src="assets/frontend/images/layout-2/product/1.jpg" class="img-fluid  " alt="product">
                        </a>
                      </div>
                      <div class="product-back">
                        <a href="product-page(left-sidebar).html">
                          <img src="assets/frontend/images/layout-2/product/a1.jpg" class="img-fluid  " alt="product">
                        </a>
                      </div>
                ...
                <div>
                  <div class="product-box">
                    <div class="product-imgbox">
                      <div class="product-front">
                        <a href="product-page(left-sidebar).html">
                          <img src="assets/frontend/images/layout-2/product/3.jpg" class="img-fluid  " alt="product">
                        </a>
                      </div>
                      <div class="product-back">
                        <a href="product-page(left-sidebar).html">
                          <img src="assets/frontend/images/layout-2/product/a3.jpg" class="img-fluid  " alt="product">
                        </a>
                      </div>
                      <div class="product-icon icon-inline">
                        <button  onclick="openCart()" class="tooltip-top" data-tippy-content="Add to cart" >
                ...
                <div>
                  <div class="product-box">
                    <div class="product-imgbox">
                      <div class="product-front">
                        <a href="product-page(left-sidebar).html">
                          <img src="assets/frontend/images/layout-2/product/4.jpg" class="img-fluid  " alt="product">
                        </a>
                      </div>
                      <div class="product-back">
                        <a href="product-page(left-sidebar).html">
                          <img src="assets/frontend/images/layout-2/product/a4.jpg" class="img-fluid  " alt="product">
                        </a>
                      </div>
                      <div class="product-icon icon-inline">
                        <button  onclick="openCart()" class="tooltip-top" data-tippy-content="Add to cart" >
                ...
                <div>
                  <div class="product-box">
                    <div class="product-imgbox">
                      <div class="product-front">
                        <a href="product-page(left-sidebar).html">
                          <img src="assets/frontend/images/layout-2/product/5.jpg" class="img-fluid  " alt="product">
                        </a>
                      </div>
                      <div class="product-back">
                        <a href="product-page(left-sidebar).html">
                          <img src="assets/frontend/images/layout-2/product/a5.jpg" class="img-fluid  " alt="product">
                        </a>
                      </div>
                      <div class="product-icon icon-inline">
                        <button  onclick="openCart()" class="tooltip-top" data-tippy-content="Add to cart" >
                ...
                <div>
                  <div class="product-box">
                    <div class="product-imgbox">
                      <div class="product-front">
                        <a href="product-page(left-sidebar).html">
                          <img src="assets/frontend/images/layout-2/product/6.jpg" class="img-fluid  " alt="product">
                        </a>
                      </div>
                      <div class="product-back">
                        <a href="product-page(left-sidebar).html">
                          <img src="assets/frontend/images/layout-2/product/a6.jpg" class="img-fluid  " alt="product">
                        </a>
                      </div>
                      <div class="product-icon icon-inline">
                        <button  onclick="openCart()" class="tooltip-top" data-tippy-content="Add to cart" >
                ...
                <div>
                  <div class="product-box">
                    <div class="product-imgbox">
                      <div class="product-front">
                        <a href="product-page(left-sidebar).html">
                          <img src="assets/frontend/images/layout-2/product/7.jpg" class="img-fluid  " alt="product">
                        </a>
                      </div>
                      <div class="product-back">
                        <a href="product-page(left-sidebar).html">
                          <img src="assets/frontend/images/layout-2/product/a7.jpg" class="img-fluid  " alt="product">
                        </a>
                      </div>
                      <div class="product-icon icon-inline">
                        <button  onclick="openCart()" class="tooltip-top" data-tippy-content="Add to cart" >
                ...
                <div>
                  <div class="product-box">
                    <div class="product-imgbox">
                      <div class="product-front">
                        <a href="product-page(left-sidebar).html">
                          <img src="assets/frontend/images/layout-2/product/8.jpg" class="img-fluid  " alt="product">
                        </a>
                      </div>
                      <div class="product-back">
                        <a href="product-page(left-sidebar).html">
                          <img src="assets/frontend/images/layout-2/product/a8.jpg" class="img-fluid  " alt="product">
                        </a>
                      </div>
                      <div class="product-icon icon-inline">
                        <button  onclick="openCart()" class="tooltip-top" data-tippy-content="Add to cart" >
    ...
    <div class="row">
      <div class="col">
        <div class="collection-banner-main banner-5 p-center">
          <div class="collection-img">
            <img src="assets/frontend/images/layout-2/collection-banner/7.jpg" class="bg-img  " alt="banner">
          </div>
          <div class="collection-banner-contain ">
        ...
        <div class="slide-6 no-arrow">
            ...
            <div class="category-contain">
              <div class="img-wrapper">
                <a href="category-page(left-sidebar).html">
                  <img src="assets/frontend/images/layout-1/rounded-cat/1.png" alt="category  " class="img-fluid">
                </a>
              </div>
          ...
          <div>
            <div class="category-contain">
              <div class="img-wrapper">
                <a href="category-page(left-sidebar).html">
                  <img src="assets/frontend/images/layout-1/rounded-cat/2.png" alt="category  " class="img-fluid">
                </a>
              </div>
              <a href="category-page(left-sidebar).html" class="btn-rounded">
                furniture
          ...
          <div>
            <div class="category-contain">
              <div class="img-wrapper">
                <a href="category-page(left-sidebar).html">
                  <img src="assets/frontend/images/layout-1/rounded-cat/3.png" alt="category  " class="img-fluid">
                </a>
              </div>
              <a href="category-page(left-sidebar).html" class="btn-rounded">
                bag
          ...
          <div>
            <div class="category-contain">
              <div class="img-wrapper">
                <a href="category-page(left-sidebar).html">
                  <img src="assets/frontend/images/layout-1/rounded-cat/4.png" alt="category  " class="img-fluid">
                </a>
              </div>
              <a href="category-page(left-sidebar).html" class="btn-rounded">
                tools
          ...
          <div>
            <div class="category-contain">
              <div class="img-wrapper">
                <a href="category-page(left-sidebar).html">
                  <img src="assets/frontend/images/layout-1/rounded-cat/5.png" alt="category  " class="img-fluid">
                </a>
              </div>
              <a href="category-page(left-sidebar).html" class="btn-rounded">
                grocery
          ...
          <div>
            <div class="category-contain">
              <div class="img-wrapper">
                <a href="category-page(left-sidebar).html">
                  <img src="assets/frontend/images/layout-1/rounded-cat/6.png" alt="category  " class="img-fluid">
                </a>
              </div>
              <a href="category-page(left-sidebar).html" class="btn-rounded">
                camera
          ...
          <div>
            <div class="category-contain">
              <div class="img-wrapper">
                <a href="category-page(left-sidebar).html">
                  <img src="assets/frontend/images/layout-1/rounded-cat/7.png" alt="category  " class="img-fluid">
                </a>
              </div>
              <a href="category-page(left-sidebar).html" class="btn-rounded">
                shoes
                ...
                <div>
                  <div class="media-banner media-banner-1 border-0">
                    <div class="media-banner-box">
                      <div class="media">
                        <a href="product-page(left-sidebar).html">
                          <img src="assets/frontend/images/layout-2/media-banner/1.jpg" class="img-fluid " alt="banner">
                        </a>
                        <div class="media-body">
                    ...
                    <div class="media-banner-box">
                      <div class="media">
                        <a href="product-page(left-sidebar).html">
                          <img src="assets/frontend/images/layout-2/media-banner/2.jpg" class="img-fluid " alt="banner">
                        </a>
                        <div class="media-body">
                          <div class="media-contant">
                            <div>
                    ...
                    <div class="media-banner-box">
                      <div class="media">
                        <a href="product-page(left-sidebar).html">
                          <img src="assets/frontend/images/layout-2/media-banner/3.jpg" class="img-fluid " alt="banner">
                        </a>
                        <div class="media-body">
                          <div class="media-contant">
                            <div>
    ...
    <div class="row collection2">
      <div class="col-md-4">
        <div class="collection-banner-main banner-1 p-left">
          <div class="collection-img">
            <img src="assets/frontend/images/layout-2/collection-banner/4.jpg" class="img-fluid bg-img " alt="banner">
          </div>
          <div class="collection-banner-contain ">
            <div>
              <h3>Leather</h3>
      ...
      <div class="col-md-4">
        <div class="collection-banner-main banner-1 p-left">
          <div class="collection-img">
            <img src="assets/frontend/images/layout-2/collection-banner/5.jpg" class="img-fluid bg-img " alt="banner">
          </div>
          <div class="collection-banner-contain ">
            <div>
              <h3>nike</h3>
      ...
      <div class="col-md-4">
        <div class="collection-banner-main banner-1 p-left">
          <div class="collection-img">
            <img src="assets/frontend/images/layout-2/collection-banner/6.jpg" class="img-fluid bg-img " alt="banner">
          </div>
          <div class="collection-banner-contain ">
            <div>
              <h3>Printing 3D</h3>
              ...
              <div class="row hot-deal-subcontain hotdeal-block1">
                  ...
                  <div class="hotdeal-right-slick border-0">
                    <a href="product-page(left-sidebar).html">
                      <div class="img-wrraper">
                        <div>
                          <img src="assets/frontend/images/layout-2/hot-deal/8.jpg" alt="hot-deal" class="img-fluid  bg-img">
                        </div>
                      </div>
                    </a>
                    <a href="product-page(left-sidebar).html">
                      <div class="img-wrraper">
                        <div>
                          <img src="assets/frontend/images/layout-2/hot-deal/7.jpg" alt="hot-deal" class="img-fluid  bg-img">
                        </div>
                      </div>
                    </a>
                    <a href="product-page(left-sidebar).html">
                      <div class="img-wrraper">
                        <div>
                          <img src="assets/frontend/images/layout-2/hot-deal/6.jpg" alt="hot-deal" class="img-fluid  bg-img">
                        </div>
                      </div>
                    </a>
                    <a href="product-page(left-sidebar).html">
                      <div class="img-wrraper">
                        <div>
                          <img src="assets/frontend/images/layout-2/hot-deal/5.jpg" alt="hot-deal" class="img-fluid  bg-img">
                        </div>
                      </div>
                    </a>
                  </div>
                ...
                <div class="col-md-2 ">
                  <div class="hotdeal-right-nav">
                    <div><img src="assets/frontend/images/layout-2/hot-deal/8.jpg" alt="hot-dea" class="img-fluid  " ></div>
                    <div><img src="assets/frontend/images/layout-2/hot-deal/7.jpg" alt="hot-dea" class="img-fluid  " ></div>
                    <div><img src="assets/frontend/images/layout-2/hot-deal/6.jpg" alt="hot-dea" class="img-fluid  " ></div>
                    <div><img src="assets/frontend/images/layout-2/hot-deal/5.jpg" alt="hot-dea" class="img-fluid  " ></div>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div>
            <div class="product-box">
              <div class="product-imgbox">
                <div class="product-front">
                  <a href="product-page(left-sidebar).html">
                    <img src="assets/frontend/images/layout-2/product/2.jpg" class="img-fluid  " alt="product">
                  </a>
                </div>
                <div class="product-back">
                  <a href="product-page(left-sidebar).html">
                    <img src="assets/frontend/images/layout-2/product/a2.jpg" class="img-fluid  " alt="product">
                  </a>
                </div>
                <div class="product-icon icon-inline">
                  <button  onclick="openCart()" class="tooltip-top" data-tippy-content="Add to cart" >
          ...
          <div class="footer-main">
            <div class="footer-box">
              ...
              <div class="footer-contant">
                ...
                <ul class="paymant">
                  <li><a href="javascript:void(0)"><img src="assets/frontend/images/layout-1/pay/1.png" class="img-fluid" alt="pay"></a></li>
                  <li><a href="javascript:void(0)"><img src="assets/frontend/images/layout-1/pay/2.png" class="img-fluid" alt="pay"></a></li>
                  <li><a href="javascript:void(0)"><img src="assets/frontend/images/layout-1/pay/3.png" class="img-fluid" alt="pay"></a></li>
                  <li><a href="javascript:void(0)"><img src="assets/frontend/images/layout-1/pay/4.png" class="img-fluid" alt="pay"></a></li>
                  <li><a href="javascript:void(0)"><img src="assets/frontend/images/layout-1/pay/5.png" class="img-fluid" alt="pay"></a></li>
                </ul>
              </div>
            </div>
            <div class="footer-box">
        ...
        <div class="news-latter">
          <div class="modal-bg">
            ...
            <div class="imd-wrraper">
                <img src="assets/frontend/images/subscribe/1.jpg" alt="newsletterimg" class="img-fluid bg-img">
            </div>
            </div>
          </div>
        </div>
        ...
        <div class="row">
          <div class="col-lg-6 col-xs-12">
            <div class="quick-view-img">
              <img src="assets/frontend/images/layout-1/product/3.jpg" alt="" class="img-fluid bg-img">
            </div>
          </div>
                ...
                <div class="modal fade" id="sizemodal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                  <div class="modal-dialog modal-dialog-centered" role="document">
                    <div class="modal-content">
                      ...
                      <div class="modal-body"><img src="assets/frontend/images/size-chart.jpg" alt="" class="img-fluid "></div>
                    </div>
                  </div>
                </div>
                <div class="size-box">
...
<div class="product-notification" id="dismiss">
  ...
  <div class="media">
    <img class="me-2" src="assets/frontend/images/layout-1/product/5.jpg" alt="Generic placeholder image">
    <div class="media-body">
...
<!-- timer js -->
<script src="assets/frontend/js/timer2.js"></script>

<!-- Bootstrap js-->
<script src="assets/frontend/js/bootstrap.js"></script>

<!-- tool tip js -->
<script src="assets/frontend/js/tippy-popper.min.js"></script>
<script src="assets/frontend/js/tippy-bundle.iife.min.js"></script>

<!-- father icon -->
<script src="assets/frontend/js/feather.min.js"></script>
<script src="assets/frontend/js/feather-icon.js"></script>
