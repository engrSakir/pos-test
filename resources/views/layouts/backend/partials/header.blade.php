            ...
            <div class="collapse navbar-collapse justify-content-between">
                ...
                <ul class="navbar-nav header-right main-notification">
                                    ...
                                    <li>
                                        <div class="timeline-panel">
                                            <div class="media mr-2">
                                                <img alt="image" width="50" src="assets/backend/images/avatar/1.jpg">
                                            </div>
                    ...
                    <li class="nav-item d-sm-flex d-none">
                        <a class="nav-link  ai-icon" href="{{ route('pos') }}" target="_blank" role="button">
                          <svg width="24" height="24" viewBox="0 0 28 28" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <li class="nav-item dropdown header-profile">
                        <a class="nav-link" href="#" role="button" data-toggle="dropdown">
                            <img src="{{ asset(auth()->user()->image ?? 'assets/images/no_image.png') }}" width="20" alt=""/>
