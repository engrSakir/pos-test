        ...
        <div class="container-fluid">
                    ...
                    <div class="widget-stat card bg-danger">
                        <div class="card-body  p-4">
                            <div class="media">
                                ...
                                <div class="media-body text-white text-right">
                                    <p class="mb-1"> Expense of {{ $month }}/{{ $year }}</p>
                                    <h3 class="text-white">{{ $total_expense_amount }}</h3>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="row">
                        ...
                        <div class="card-body pb-0">
                            <ul class="list-group list-group-flush">
                                <li class="list-group-item d-flex px-0 justify-content-between">
                                    <strong>Total</strong>
                                    <span class="mb-0">{{ $total_items }}</span>
                                </li>
                                <li class="list-group-item d-flex px-0 justify-content-between">
                                    <strong>Active</strong>
                                    <span class="mb-0">{{ $total_active_items }}</span>
                                </li>
                                <li class="list-group-item d-flex px-0 justify-content-between">
                                    <strong>Inactive</strong>
                                    <span class="mb-0 text-danger">{{ $total_inactive_items }}</span>
                                </li>
                                <li class="list-group-item d-flex px-0 justify-content-between">
                                    <strong>Online</strong>
                                    <span class="mb-0">{{ $total_active_online_items }}</span>
                                </li>
                                <li class="list-group-item d-flex px-0 justify-content-between">
                                    <strong>Only Offline</strong>
                                    <span class="mb-0 text-danger">{{ $total_inactive_online_items }}</span>
                                </li>
                            </ul>
                        </div>
                    </div>
                ...
                <div class="col-xl-4 col-lg-12 col-sm-12">
                    <div class="card">
                        <div class="card-header border-0 pb-0">
                            <h2 class="card-title">Today's Categories</h2>
                        </div>
                        <div class="card-body pb-0">
                            <ul class="list-group list-group-flush">
                                <li class="list-group-item d-flex px-0 justify-content-between">
                                    <strong>Total</strong>
                                    <span class="mb-0">{{ $total_categories }}</span>
                                </li>
                                <li class="list-group-item d-flex px-0 justify-content-between">
                                    <strong>Active</strong>
                                    <span class="mb-0">{{ $total_active_categories }}</span>
                                </li>
                                <li class="list-group-item d-flex px-0 justify-content-between">
                                    <strong>Inactive</strong>
                                    <span class="mb-0 text-danger">{{ $total_inactive_categories }}</span>
                                </li>
                                <li class="list-group-item d-flex px-0 justify-content-between">
                                    <strong>Online</strong>
                                    <span class="mb-0">{{ $total_active_online_categories }}</span>
                                </li>
                                <li class="list-group-item d-flex px-0 justify-content-between">
                                    <strong>Only Offline</strong>
                                    <span class="mb-0 text-danger">{{ $total_inactive_online_categories }}</span>
                                </li>
                            </ul>
                        </div>
                    </div>
