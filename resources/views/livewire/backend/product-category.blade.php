    ...
    <x-slot name="header">
        <div class="sub-header">
            <div class="d-flex align-items-center flex-wrap mr-auto">
                <h5 class="dashboard_bar">Product Category</h5>
            </div>
                                ...
                                <table class="table table-responsive-md table-hover">
                                    <thead>
                                        <tr>
                                            ...
                                            <th><strong>{{ __('Online') }}</strong></th>
                                            <th><strong>{{ __('Name') }}</strong></th>
                                            <th><strong>{{ __('Products') }}</strong></th>
                                    ...
                                    <tbody>
                                        @foreach ($productCategories as $productCategory)
                                            <tr>
                                                ...
                                                <td>{{ $productCategory->created_at->format('d M Y') }}</td>
                                                <td>
                                                    <div class="d-flex">
                                                        <a href="javascript:void(0)"
                                                            wire:click="select_for_edit({{ $productCategory->id }})"
                                                            data-toggle="modal" data-target="#create_and_edit_modal"
                                                            class="btn btn-primary shadow btn-xs sharp mr-1"><i
                                                                class="fa fa-pencil"></i></a>
                                                        <a href="javascript:void(0)"
                                                            wire:click="select_for_delete({{ $productCategory->id }})"
